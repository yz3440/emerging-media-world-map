// General configurations for Mapbox, Airtable, utilities, and site metadata
...
const config = {
  ...
  // Meta data for location filtering
  filters: [
    {
      type: 'checkbox',
      title: 'Type: ',
  ...
  // Layer styles are converted from style settings on Mapbox Studio
  layerStyles: {
    location: {
      layout: {
